...
nums.sort();
console.log(nums);
//output sorts based first two digits of the number and ignores the other digits
nums.sort(
...
console.log(newJoin); //it converts or combines elements inside an array into string

newJoin = meal.join("");
console.log (newJoin); // Removes the comma and deletes spaces

newJoin = meal.join(" "); // Removes the comma and  provides spaces
console.log (newJoin); 

newJoin = meal.join(" , "); // adds comma and spaces before and after the comma
console.log (newJoin);
...
console.log(typeof elements[2]); //to know the DATA TYPE of the element "typeof"

let newString = elements.toString();
console.log(newString); // it converts the elements to string with comma
...
console.log(index); // 7th index, it reads the last index of the element even if they're the same.
